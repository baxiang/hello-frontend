...
**强烈推荐先阅读：** [→ 00-TypeScript 零基础快速入门.md](./00-TypeScript 零基础快速入门.md)
...
**上一篇：** [← 04-es6+/](../04-es6+/)
**下一篇：** [→ 00-TypeScript 零基础快速入门](./00-TypeScript 零基础快速入门.md)

---

## 本章导航

- **[→ 00-TypeScript 零基础快速入门](./00-TypeScript 零基础快速入门.md)** - 完全不懂？从这里开始！
